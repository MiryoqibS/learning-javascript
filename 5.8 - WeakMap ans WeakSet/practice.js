...
У вас есть к ним доступ, но управление этим массивом происходит где-то ещё. Добавляются 
новые сообщения и удаляются старые, и вы не знаете в какой момент это может произойти.
...
// Добавили сообщение как прочитанное
readMessages.add(messages[0]);

// снова прочитали сообщение
readMessages.add(messages[0]);
...
readMessages2.set(messages2[0], new Date(2025, 5, 5));